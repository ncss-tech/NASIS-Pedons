#-------------------------------------------------------------------------------
# Name:        NASISpedons-UpdateFieldAliases_forPedonFGDBTemplate
# Purpose:     This script will update the Table and field aliases for the NASIS FGDB that
...
#
#              This script should be executed after the
#              'NASISpedons-Create_FGDBschema_fromNASIS_Metadata' script.
#
#              After running this tool, the NASISpedons_XMLWorkspace.xml can be recreated from
#              the input FGDB parameter from this tool.
#
...
if __name__ == '__main__':
    ...
    # FGDB whose field aliases will be updated
    nasisPedons = os.path.dirname(sys.argv[0]) + os.sep + "NasisPedonsTemplate.gdb"

    # Metadata Tables within the Metadata_Tables.gdb
