...
#              for all of the pedon objects and their child tables and create a
#              FGDB and their corresponding tables and fields.  The table is
...
#              spreadsheet which was then converted to a FGDB table.
#
...
if __name__ == '__main__':
    ...
    try:
        ...
        schemaTable = r'C:\python_scripts\GitHub\NASIS-Pedons\Metadata_Tables_Work.gdb\Pedon_schema_7_3_3'
